...
export default function Home() {
  ...
  return (
    <div>
    <div id="control-bar" className="w-full flex flex-row bg-purple-600 h-16  items-center">
      <img src="./assets/gator_logo.png" className="w-16 h-16 ml-4" alt="gatorlogo" />
      <div id="title" className="text-3xl ml-4">SF_Maps</div>
    </div>

    <div id="home-functions" className="w-full h-screen bg-violet-900 flex lg:flex-row md:flex-row flex-col-reverse justify-between" style={{ backgroundImage: `url('./assets/background.png')` }}>
